			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="frm" action="/studentUpdate" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="name" value="${studentVo.name }"
								placeholder="학생 이름">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<input type="hidden" id="addr1Input" name="addr1" value="${studentVo.addr1 }">
							<button id="findAddr" type="button"> 주소검색 </button>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" id="addr2" name="addr2" value="${studentVo.addr2}"
								placeholder="상세주소">
						</div>
					</div>
